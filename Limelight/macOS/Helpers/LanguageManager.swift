...
public class LanguageManager: NSObject, ObservableObject {
  ...
  private let en: [String: String] = [
    ...
    "CoreHID Max Mouse Report Rate": "CoreHID Max Mouse Report Rate",
    "CoreHID Max Mouse Report Rate hint":
      "0 means unlimited; set an upper cap to limit CoreHID mouse report frequency.",
    "Unlimited": "Unlimited",
  ...
  private let zhHans: [String: String] = [
    ...
    "CoreHID Max Mouse Report Rate": "CoreHID 最大鼠标回报率",
    "CoreHID Max Mouse Report Rate hint": "0 表示无限制；设置上限可限制 CoreHID 鼠标事件回报频率。",
    "Unlimited": "无限制",
